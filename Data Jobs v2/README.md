...
![Dashboard Page](/Images/Dashboard%20Screenshot%20(Project%202).png)
...
### Dashboard File
You can find the file for the dashboard here: [`Data Jobs Dashboard 2.0.pbix`](/Data%20Jobs%20v2/Data%20Jobs%20Dashboard%202.0.pbix).
...
* **📊 Visualizations Utilized:**
    * **📈 Core Charts:** Bar charts for comparisons and trends.
    * **🔢 Cards:** To highlight key performance indicators.
* **🖱️ Interactive Features:**
    * **🎚️ Slicers:** Enabling dynamic, user-driven data filtering.
    * **🔘 Buttons:** For easy filter clearing and managing report views.
    * **🔢 Parameters:** For streamlined switching of the measures in x-axis to get different data perspectives.
